...
//字母、全部的点击效果
function LetterClickUi(){
	//全选的点击效果
	$('.fl-journalList-letterAll').click(function(){
		$(this).addClass('active');
		$('.fl-journalList-letterRight a').removeClass('active');
	});
	//字母的点击效果
	$('.fl-journalList-letterRight a').click(function(){
		$(this).addClass('active').siblings('a').removeClass('active');
		$('.fl-journalList-letterAll').removeClass('active');
	});
}
//删除最后一个元素的下划线的方法
...
$(function(){
	...
	//下拉框选择调用
	SelectWidthAuto();
	$('.fl-journalList-select').change(function(){
		SelectWidthAuto();
	});
	//搜索条件框得到焦点去掉默认值
