...
{
	var oDiv=document.getElementById('film-header-move-box');
	mouseScroll(oDiv);
};
...
function startMove(obj, json, fnEnd)
{
	...
	obj.timer=setInterval(function (){
		...
		document.getElementById('film-header-move-box').style.left=(document.documentElement.clientWidth-document.getElementById('film-header-move-box').offsetWidth)/2+'px';
