...
(function ($) {
    ...
    $.PageFunc = function (Total, PageSize, curPageNum, FunUrl) {
        ...
        if (AllPage > 0) {
            if (curPageNum != 1) {
                //处理首页连接 
                navHtml += "<span><a class=\"firstpage\" href=\"javascript:" + FunUrl + "('1')\" ></a></span>  ";
            } else {
                navHtml += "<span class=\"firstpage\"></span>  ";
            }
            if (curPageNum > 1) {
                //处理上一页的连接 
                navHtml += "<span><a class=\"prevpage\" href=\"javascript:" + FunUrl + "('" + (curPageNum - 1) + "')\" ></a></span>  ";
            }
            else {
                navHtml += "<span  class=\"prevpage\" ></span>  ";
            }
            ...
            if (curPageNum < AllPage) {
                //处理下一页的链接 
                navHtml += "<span><a class=\"nextpage\" href=\"javascript:" + FunUrl + "('" + (parseInt(curPageNum) + 1) + "')\"></a></span>  ";
            }
            else {
                navHtml += "<span class=\"nextpage\" ></span>  ";
            }

            if (curPageNum != AllPage) {
                navHtml += "<span><a class=\"lastpage\" href=\"javascript:" + FunUrl + "('" + AllPage + "')\" ></a></span>  ";
            } else {
                navHtml += "<span class=\"lastpage\"></span>  ";
            }
