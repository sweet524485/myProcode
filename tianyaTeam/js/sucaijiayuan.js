...
function go(){
	location.href = "http://www.qiumingjie.com";
}
function backToTop(){
		clearTimeDown();
...
function signAnimate(){
					...
					$(name1).css("bottom","+="+ shift*2+"px").show().animate({"bottom":"-="+shift+"px"},interval,function(){
						$(name2).css("bottom","+="+shift*2+"px").show().animate({"bottom":"-="+shift+"px"},interval,function(){
							$(name3).css("bottom","+="+shift*2+"px").show().animate({"bottom":"-="+shift+"px"},interval,function(){
								setTimeout(function(){cicleFun(name1,name2,name3,shift,interval)},10500);
	...
	cicleFun("#sign1_1","#sign2_1","#sign3_1",30,200000000);
	cicleFun("#sign1_2","#sign2_2","#sign3_2",30,200000000);
	cicleFun("#sign1_plus","#sign2_plus","#sign3_plus",30,200000000);
	cicleFun("#sign1_3","#sign2_3","#sign3_3",30,200000000);
	cicleFun("#sign1_4","#sign2_4","#sign3_4",30,200000000);
